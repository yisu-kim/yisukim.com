...
[React 공식 문서 스터디 with Hypothesis](/posts/the-react-docs-study-with-hypothesis) 글에서 Hypothesis라는 브라우저 익스텐션을 소개한 적이 있다. 웹 문서에 하이라이트를 남기고 실시간으로 주석을 공유할 수 있는 툴인데 지난 React 스터디에서 매우 유용하게 사용했다.
...
![스크롤 이슈](/posts/contribute-to-hypothesis/스크롤_이슈.gif)
...
![디테일 태그](/posts/contribute-to-hypothesis/디테일_태그.png)
...
![깃허브 레포 목록](/posts/contribute-to-hypothesis/깃허브_레포_목록.png)
...
![깃허브 주요 레포](/posts/contribute-to-hypothesis/깃허브_주요_레포.png)
...
![익스텐션 디벨로퍼 모드](/posts/contribute-to-hypothesis/익스텐션_디벨로퍼_모드.png)
...
![프로젝트 웰컴 페이지](/posts/contribute-to-hypothesis/프로젝트_웰컴_페이지.png)
...
![변경사항_반영_확인](/posts/contribute-to-hypothesis/변경사항_반영_확인.png)
...
![버그 해결](/posts/contribute-to-hypothesis/버그_해결.gif)
...
![Codecov 리포트](/posts/contribute-to-hypothesis/Codecov_리포트.png)

![테스트 코드리뷰](/posts/contribute-to-hypothesis/테스트_코드리뷰.png)
...
![테스트 수행 결과](/posts/contribute-to-hypothesis/테스트_수행_결과.png)
...
![신규 추가 테스트 결과](/posts/contribute-to-hypothesis/신규_추가_테스트_결과.png)

테스트가 통과하는 것을 확인했으니 커밋해서 올렸다. 이후 테스트 코드를 리뷰 받고 나자 100% 커버리지를 회복할 수 있었다.

![Codecov 리포트 갱신](/posts/contribute-to-hypothesis/Codecov_리포트_갱신.png)

### 7. PR 작성하기

테스트 코드까지 모두 완성해서 브랜치에 올렸다면 이제 PR을 작성할 시간이다. 디폴트 브랜치에 자신의 작업 브랜치를 머지하는 PR을 열어보자.

![PR 브랜치](/posts/contribute-to-hypothesis/PR_브랜치.png)
...
![PR 내용](/posts/contribute-to-hypothesis/PR_내용.png)

### 8. 코드 리뷰에 피드백하고 승인받기

가장 기대되는 파트다. 이런 기회가 아니면 언제 오픈소스 메인테이너에게 코드 리뷰를 받을 수 있을까?

![코드리뷰 1](/posts/contribute-to-hypothesis/코드리뷰_1.png)

![코드리뷰 2](/posts/contribute-to-hypothesis/코드리뷰_2.png)

![코드리뷰 3](/posts/contribute-to-hypothesis/코드리뷰_3.png)
...
![코드리뷰 4](/posts/contribute-to-hypothesis/코드리뷰_4.png)

![코드리뷰 5](/posts/contribute-to-hypothesis/코드리뷰_5.png)
...
![메인테이너 PR 승인](/posts/contribute-to-hypothesis/메인테이너_PR_승인.png)
